import { siteOrigin, toCanonicalPath } from "./canonical";
...
export const routeSeo: Record<RouteSeoKey, SeoMeta> = {
  ...
  "/reviews": {
    ...
    canonicalPath: toCanonicalPath("/reviews"),
    ogImage: defaultOgImage,
  ...
  "/instructions": {
    ...
    canonicalPath: toCanonicalPath("/instructions"),
    ogImage: defaultOgImage,
  ...
  "/mcp": {
    ...
    canonicalPath: toCanonicalPath("/mcp"),
    ogImage: defaultOgImage,
    keywords:
  ...
  "/architecture": {
    ...
    canonicalPath: toCanonicalPath("/architecture"),
    ogImage: defaultOgImage,
    keywords:
  ...
  "/about": {
    ...
    canonicalPath: toCanonicalPath("/about"),
    ogImage: defaultOgImage,
  ...
  "/terms": {
    ...
    canonicalPath: toCanonicalPath("/terms"),
    ogImage: defaultOgImage,
  ...
  "/privacy": {
    ...
    canonicalPath: toCanonicalPath("/privacy"),
    ogImage: defaultOgImage,
