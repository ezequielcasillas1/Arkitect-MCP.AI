...
| Server name | `arkitect-mcp` (v0.2.1) |
...
| Windows installer (v0.2.1) | [Arkitect-Setup.exe](https://github.com/ezequielcasillas1/Arkitect-MCP.AI/releases/download/v0.2.1/Arkitect-Setup.exe) |
...
*Last updated: July 2026 — arkitect-mcp v0.2.1.*
